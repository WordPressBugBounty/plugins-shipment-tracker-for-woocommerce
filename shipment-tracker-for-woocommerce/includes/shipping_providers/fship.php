...
public function test_fship()
{
    ...
    private function get_fship_order_object($order_id)
    {
        ...
        $order_data = [
            ...
            "orderId" => apply_filters( 'bt_sst_push_order_number', $order->get_order_number(), $order ),
            "invoice_Number" => apply_filters( 'bt_sst_push_order_number', $order->get_order_number(), $order ),
