...
class Bt_Sync_Shipment_Tracking_Rest {
    ...
    public function rest_ekart_webhook(){
        register_rest_route( $this->rest_route_ekart . '/' . $this->version , 'webhook_receiver', array(
            'methods' => 'POST',
            'callback' => array($this->rest_functions,"ekart_webhook_receiver"),
            'permission_callback' => '__return_true',
        ));
    }
