        ...
        <div class="bt_sst_popup-content">
            ...
            <div id="">
                <div>
                    ...
                    <input type="text" id="bt_sst_ship24_awb_field" name="bt_sst_ship24_awb_field"
                        class="bt_sst_ship24_input">
                </div>
                <div id="bt_sst_ship24_corier_data">
                    <div>
                        <label for="">Courier:</label>
                    </div>
                    <select style="width:100%" name="bt_sst_ship24_couriers_list" id="bt_sst_ship24_couriers_name"
                        class="bt_sst_ship24_input">
                        ...
                        if (is_array($coriure_name) && count($coriure_name) > 1) {
                            ...
                            foreach ($coriure_name as $key => $courier) {
                                ...
                                ?>
                                <option value='<?php echo esc_attr($courierCodeAndName) ?>'
                                    data-courierName='<?php echo esc_attr($courier['courierName']) ?>'>
                                    <?php echo esc_attr($courier['courierName']) ?></option>
                            <?php }
                        } else { ?>
...
<style>
    ...
    #bt_notify_popup_ship24 .button {
        ...
        /* WooCommerce/WordPress Primary Color */
        color: #fff;
        border-radius: 5px;
        cursor: pointer;
        font-size: 16px;
