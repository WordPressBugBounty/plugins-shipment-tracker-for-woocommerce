								...
								<section class="modal-card-body">
									<div class="container columns">
										<div class="column ">
											...
											<input id="bt_sms_input_credits_buy" value="" class="input is-medium mb-2" required type="number" name="quantity" maxlength="7" min="1000" max="200000" placeholder="Enter quantity"/><br>
